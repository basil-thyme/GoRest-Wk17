...
public class PostsExtractionTest {
    ...
    public void test001() {
        ...
        System.out.println("All the titles are : " + title);
    }
    ...
    public void test006() {
        ...
        System.out.println("The title of all records whose user_id = 2223281 is:  " + title);
    }

    // 7. Extract the body of all records whose id = 2671
    @Test
    public void test007() {
        String body = response.extract().path("find{it.id == 38826}.body");
        System.out.println("The title of all records whose user_id = 38826 is:  " + body);
    }
