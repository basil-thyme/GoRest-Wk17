...
public class UserAssertionTest {
    ...
    @Test
    public void test003() {
        response.body("name", hasItem("Aatreya Shah"));
    ...
    @Test
    public void test004() {
        response.body("name", hasItems("Aatreya Shah", "Meghnath Devar", "Chandni Trivedi"));
    ...
    @Test
    public void test005() {
        response.body("find { it.id == 2223226 }.email" , equalTo("chaturvedi_krishnadas@bins.example"));
    }
    ...
    @Test
    public void test006() {
        response.body("find { it.name == 'Krishnadas Chaturvedi' }.status" , equalTo("inactive"));
